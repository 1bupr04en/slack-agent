...
```
"Check if I'm paused"           ?� calls get_status()
"Pause my work"                 ?� calls manual_pause()
"Resume working"                ?� calls manual_resume()
"Set timeout to 2 minutes"      ?� calls set_leave_timeout(120)
```
...
3. Restart Claude Desktop
4. See [docs/DEPLOY_CLAUDE.md](docs/DEPLOY_CLAUDE.md) ?� Troubleshooting
